...
sys.path.append('../web-framework-demo')
...
class UsersTests(unittest.TestCase):
    ...
    def test_invalid_username_registration(self):
        ...
        response2 = self.register('maybetheyretellingusthattheendneverwasneverwill', 'test@example.com', 'FlaskIsAwesome','FlaskIsAwesome')
    ...
    def test_invalid_email_registration(self):
        ...
        response2 = self.register('test2', 'testytest', 'FlaskIsAwesome','FlaskIsAwesome')
        self.assertIn(b'Invalid email address.', response.data)
        self.assertIn(b'Invalid email address.', response2.data)
    
    def test_invalid_confirm_registration(self):
        response = self.register('t', 'test@example.com', 'FlaskIsAwesome','FlaksIsAwesome')
        #print(response.data)
